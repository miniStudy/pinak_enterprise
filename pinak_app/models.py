...
class Machines(models.Model):
    ...
    machine_owner_name = models.CharField(max_length=155, null=True, blank=True)
    machine_owner_contact = models.CharField(max_length=15, null=True, blank=True)
...
class Project(models.Model):
    ...
    project_customer_name = models.CharField(max_length=155, null=True, blank=True)
    project_customer_contact = models.CharField(max_length=155, null=True, blank=True)
